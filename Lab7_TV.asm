...
main:
    ...
    # Gọi hàm proc_max để tìm giá trị lớn nhất và vị trí của nó
    jal proc_max
    ...
    # Gọi hàm proc_min để tìm giá trị nhỏ nhất và vị trí của nó
    jal proc_min
...
#----------------------------------------------
proc_max: # Quy trình để tìm giá trị lớn nhất và vị trí của nó
...
LOOP1: 
    ...
    beq $t2, $0, end_LOOP1 # Nếu không, kết thúc vòng lặp
    ...
    beq $t3, $0, continue1 # Nếu không, tiếp tục với vòng lặp
